...
export default function RegisterForm({ onSwitchToLogin }: RegisterFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="register-phone" className="block text-sm font-medium text-slate-300 mb-2">
      ...
      <div>
        ...
        {password && (
          <div className="mt-2">
            ...
            <p className={`text-xs ${passwordStrength.level === 3 ? 'text-emerald-400' : passwordStrength.level === 2 ? 'text-yellow-400' : 'text-red-400'}`}>
